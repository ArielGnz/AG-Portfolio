  ...
  return (
    <section className='flex flex-col mt-[120px] lg:flex-row lg:h-screen lg:w-[80%] lg:m-auto lg:content-center'>
        <div className='p-10 lg:w-[90%] my-10 w-full lg:h-[700px] lg:self-center lg:content-center '>
            ...
            <div className='mt-3'>
                <button className='mt-3  border-2 rounded border-sky-500 p-4 w-[250px] text-white text-lg tracking-widest hover:bg-sky-900'> Descargar CV </button>
            </div>
           
        </div>
        <div className='my-10 w-full lg:content-center'>
                <img className='w[300px] h-[320px] m-auto
                 lg:w-[500px] lg:h-[60%] lg:bg-center lg:bg-no-repeat ' src={dev}/>
        </div>
    </section>
  )
}
