...
export default function Countries() {
  ...
  const countriesWeb = () =>{
    const url = "https://pi-countries-nine-psi.vercel.app/";
    ...
    <>
        ...
        <div className='text-white lg:h-[300px] w-[80%] m-auto lg:w-[80%] '>
            ...
            <p className='text-white text-xl lg:w-[90%] lg:m-auto '>El proyecto de countries es una página web donde se pueden visualizar todos los países en su home Page,
             ...
             <button className='mx-1 p-1 rounded-md transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300'
                     onClick={countriesWeb}>
               Ver Pagina 
               </button></p>
        </div>
